...
export type StageState = {
  ...
  dagCanFocusRoot: boolean;
  dagCanInsertParent: boolean;
  dagCanMoveDepthIn: boolean;
  dagCanMoveDepthOut: boolean;
  dagCanMoveLaneDown: boolean;
  dagCanMoveLaneUp: boolean;
  dagCanMoveRankBackward: boolean;
  dagCanMoveRankForward: boolean;
  dagCanSpawnChild: boolean;
  dagEdgeCount: number;
  dagFullWorkplaneCount: number;
  dagGraphPointWorkplaneCount: number;
  dagLabelPointWorkplaneCount: number;
  dagLayoutFingerprint: string;
  dagNodeCount: number;
  dagRootWorkplaneId: string;
  dagTitleOnlyWorkplaneCount: number;
