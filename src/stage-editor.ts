...
const DEFAULT_EDITOR_LABEL_COLOR: RgbaColor = [0.82, 0.94, 1, 1];
const DEFAULT_EDITOR_LABEL_SIZE = 0.34;
const DEFAULT_EDITOR_LINK_COLOR: RgbaColor = [0.62, 0.88, 1, 0.46];
const DEFAULT_EDITOR_LINK_LINE_WIDTH = 2.2;
