...
export const DAG_RANK_FANOUT_NODES: readonly DagRankFanoutNodeSpec[] = [
  ...
  {
    dependsOn: ['wp-1'],
    position: {column: 1, row: 2, layer: 0},
    role: 'Ingress South',
    workplaneId: 'wp-4',
  },
  {
    dependsOn: ['wp-1'],
    position: {column: 1, row: 3, layer: 0},
    role: 'Ingress West',
    workplaneId: 'wp-5',
  },
  {
  ...
  {
    dependsOn: ['wp-4'],
    position: {column: 2, row: 2, layer: 0},
    role: 'Compute South',
    workplaneId: 'wp-8',
  },
  {
    dependsOn: ['wp-5'],
    position: {column: 2, row: 3, layer: 0},
    role: 'Compute West',
    workplaneId: 'wp-9',
  },
  {
  ...
  {
    dependsOn: ['wp-8'],
    position: {column: 3, row: 2, layer: 0},
    role: 'Publish South',
    workplaneId: 'wp-12',
  },
] as const;
